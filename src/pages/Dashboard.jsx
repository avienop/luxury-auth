...
// //   // Handle logout
// //   const handleLogout = () => {
// //     localStorage.removeItem("token"); // remove saved auth token
...
const Dashboard = () => {
  ...
  const navOptions = [
    ...
    { title: "Cards", icon: <CreditCard className="w-12 h-12 text-blue-600" />, desc: "Manage your credit and debit cards", path: "/cards" },
    { title: "Savings", icon: <PiggyBank className="w-12 h-12 text-yellow-600" />, desc: "Track your savings and goals", path: "/savings" },
    { title: "Transactions", icon: <ClipboardList className="w-12 h-12 text-purple-600" />, desc: "Review recent transactions", path: "/transactions" },
    { title: "Profile", icon: <User className="w-12 h-12 text-pink-600" />, desc: "Update your personal info", path: "/profile" },
    { title: "Settings", icon: <Settings className="w-12 h-12 text-gray-600" />, desc: "Adjust your preferences", path: "/settings" },
  ];
